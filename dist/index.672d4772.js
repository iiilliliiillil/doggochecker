...
class App {
    ...
    _loadMap(position) {
        ...
        L.marker(coords, {
            icon: myIcon
        }).addTo(this.#map).bindPopup("\u0412\u044B \u043D\u0430\u0445\u043E\u0434\u0438\u0442\u0435\u0441\u044C \u0442\u0443\u0442").openPopup();
    ...
    _showHelpNumber() {}
    _showShelters() {
        L.marker(shelters.tamaz, {
            icon: shelIcon
        }).addTo(this.#map).bindPopup("\u0420\u0430\u0439\u043E\u043D \u0422\u0430\u043C\u0430\u0437. \u0420\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u043A\u0440\u0443\u0433\u043B\u043E\u0441\u0443\u0442\u043E\u0447\u043D\u043E. \u0422\u0435\u043B: 595 63 36 36").openPopup();
        L.marker(shelters.vake, {
            icon: shelIcon
        }).addTo(this.#map).bindPopup("\u0420\u0430\u0439\u043E\u043D \u0412\u0430\u043A\u0435. \u0420\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0434\u043E 19:00. \u0422\u0435\u043B: 595 63 36 36").openPopup();
        L.marker(shelters.varketili, {
            icon: shelIcon
        }).addTo(this.#map).bindPopup("\u0420\u0430\u0439\u043E\u043D \u0412\u0430\u0440\u043A\u0435\u0442\u0438\u043B\u0438. \u0420\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u043A\u0440\u0443\u0433\u043B\u043E\u0441\u0443\u0442\u043E\u0447\u043D\u043E. \u0422\u0435\u043B: 595 63 36 36").openPopup();
        L.marker(shelters.saburtalo, {
            icon: shelIcon
        }).addTo(this.#map).bindPopup("\u0420\u0430\u0439\u043E\u043D \u0421\u0430\u0431\u0443\u0440\u0442\u0430\u043B\u043E. \u0420\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u043A\u0440\u0443\u0433\u043B\u043E\u0441\u0443\u0442\u043E\u0447\u043D\u043E. \u0422\u0435\u043B: 595 63 36 36").openPopup();
    }
    _newWorkout(ev) {
        ev.preventDefault();
        const pos = [
